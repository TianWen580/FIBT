...
model = dict(
    ...
    decode_head=dict(
        interaction_cfg=(
            dict(type='IdentityTwoBranchesCR', inchannel=512, out_se=True),
            dict(type='IdentityTwoBranchesCR', inchannel=512),
            dict(type='IdentityTwoBranchesCR', inchannel=256),
            dict(type='IdentityTwoBranchesCR', inchannel=128)
        ),
        is_fdaf=False,
        num_classes=2,
